...
z_bnds = cfdm.Bounds(data=cfdm.Data([[1.0, 2.0]]))
z_bnds.nc_set_variable('height_bnds')
...
bounds2=cfdm.Bounds(data=cfdm.Data([[5., 15.]]))
bounds2.nc_set_variable( 'a_bnds' )
...
domain_ancillary_a.nc_set_variable( 'aaaa' )
